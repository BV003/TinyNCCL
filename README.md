...
torchrun --nproc_per_node=2 tests/test_vs_torch_distributed.py 不行
TORCH_DISTRIBUTED_DEBUG=DETAIL torchrun --nproc_per_node=2 tests/ 可以test_vs_torch_distributed.py
